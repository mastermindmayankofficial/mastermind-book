...
PICS = (environ.get('PICS', 'https://graph.org/file/a606bd677470c92c30a23.mp4 https://graph.org/file/41805d8ffc0c9028c8357.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6627331552 6714624685 1720812150').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002059212513') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001834584233')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002059212513')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002078436158').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "MASTERMIND")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'not_book_search_bot')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'not_updates') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/books_audiobooks_pdf_epub')
...
FORMAT = ["mp4", "zip", "pdf", "epub", "mobi", "m4b", "mp3"]
